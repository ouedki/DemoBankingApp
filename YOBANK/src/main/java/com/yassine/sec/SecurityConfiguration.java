...
//	          .and().withUser("admin").password("1234").roles("ADMIN","USER");
	...
	@Override
	  protected void configure(HttpSecurity http) throws Exception {
	    ...
	    http.authorizeRequests().antMatchers("/operations", "/checkAcc").hasRole("USER");
	    http.authorizeRequests().antMatchers("/makeTransaction").hasRole("ADMIN");
